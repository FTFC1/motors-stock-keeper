...
export function ModelCombobox({
  ...
  const displayedOptions = React.useMemo(() => {
    ...
    if (shouldShowAddNew && inputValue.trim()) {
      options = [
        { value: `__ADD_NEW__:${inputValue.trim()}`, label: `Add "${inputValue.trim()}"`, brandId: brandId || "" },
        ...options
      ]
    }
              ...
              {displayedOptions.map((model, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    model.value.startsWith("__ADD_NEW__:") && "border-t border-dashed font-medium text-primary"
                  )}
                >
