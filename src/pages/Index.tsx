              ...
              <div className="flex flex-col justify-center space-y-4 animate-slideUp">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Efficiently manage automotive stock with real-time updates. Designed specifically for internal teams to track inventory with precision and ease.
                  </p>
                </div>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button onClick={() => navigate('/login')} size="lg" className="h-12">
                    Get Started
                  </Button>
                  <Button onClick={() => navigate('/login')} variant="outline" size="lg" className="h-12">
                    Learn More
                  </Button>
                </div>
              </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="space-y-4 p-6 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Sign in to access the full dashboard with comprehensive inventory management tools.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Designed specifically for automotive companies to manage their vehicle inventory with precision and ease.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description: "Make inventory changes and see them reflected instantly across all user sessions.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                },
                {
                  ...
                  description: "Secure access controls tailored for Admins and Sales Staff with appropriate permissions.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                },
                {
                  ...
                  description: "Powerful search and filtering options to quickly find the exact vehicles you need.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
